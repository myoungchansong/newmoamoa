...
public class hotelDTO {
	...
	public String toString() {
		return "hotelDTO [hotelname=" + hotelname + ", hoteladdr=" + hoteladdr + ", writer=" + writer + ", score="
				+ score + ", title=" + title + ", review_neg=" + review_neg + ", review_pos=" + review_pos
				+ ", write_date=" + write_date + ", summary=" + summary + ", hotelimg=" + hotelimg + "]";
	}
}
