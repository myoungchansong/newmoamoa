...
<body id="board_insert">
	...
	<form  id = "frm_insert" name ="frm_insert" action="boardregistplay.bizpoll" method="POST" enctype="multipart/form-data">
	<div id="b_insert_wrap">
		...
		<div id="insert_fst">
			...
			<div id="insert_writer">
				...
				<input type="hidden" id="input_writer" name="writer" value="${sessionScope.loginUser.id}"></div>
